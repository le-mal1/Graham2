...
function newTest2() {
    let deck1 = new Deck();
    deck1.addCard(3, 2, [{ trigger: TRIGGER_START_OPPONENT_TURN_ALIVE, effect: EFFECT_ADD_FORCE_LEADER }]);
    deck1.addCard(0, 4, [{ trigger: TRIGGER_START_YOUR_TURN_ALIVE, effect: EFFECT_ADD_FORCE_LEADER }]);
    let deck2 = new Deck();
    deck2.addCard(0, 6, [{ trigger: TRIGGER_START_OPPONENT_TURN_ALIVE, effect: EFFECT_ADD_FORCE_LEADER }]);
    deck2.addCard(0, 8, [{ trigger: TRIGGER_START_YOUR_TURN_ALIVE, effect: EFFECT_CALL_SUPPORT }]);
    let match = new Match(deck1, deck2);
