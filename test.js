...
function newTest3() {
    ...
    deck1.addCard(0, 4, [{ trigger: TRIGGER_START_YOUR_TURN, effect: EFFECT_ADD_FORCE_LEADER }]);
    let deck2 = new Deck();
    deck2.addCard(0, 2, [{ trigger: TRIGGER_START_OPPONENT_TURN, effect: EFFECT_ADD_PV_CARD }]);
    deck2.addCard(0, 3, [{ trigger: TRIGGER_START_OPPONENT_TURN, effect: EFFECT_ADD_PV_CARD }]);
